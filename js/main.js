  ...
  if (yshTrack) {
    var STORIES = [
      ...
      { tag: "פרי בטן", img: "assets/segulot/pri.jpg",
        ...
        full: "אברך שלא נפקד בילדים נסע אל הציון בחבורה אחת וביקש על בנים. לפי הסיפור — נפקד בילדים. (ארבעה נסעו יחד אל הציון, וכל אחד מהם נושע בעניינו.)",
        source: "מקור: ״שחרית״, עמ׳ 18" },
      { tag: "רפואה", img: "assets/segulot/refua.jpg",
        title: "הנער שהחלים",
        sum: "נער חולה במחלה קשה — והבריא",
        full: "נער שחלה במחלה קשה עלה אל הציון עם אותה חבורה, ושפכו עליו תפילה. לפי הסיפור — הנער החלים. (ארבעה נסעו יחד אל הציון, וכל אחד מהם נושע בעניינו.)",
        source: "מקור: ״שחרית״, עמ׳ 18" },
      { tag: "פרנסה", img: "assets/segulot/parnasa.jpg",
        title: "מצא פרנסה",
        sum: "חיפש עבודה — והתקבל לעבודה טובה",
        full: "בחור שחיפש עבודה הצטרף לנסיעה אל הציון וביקש על פרנסתו. לפי הסיפור — התקבל לעבודה טובה. (ארבעה נסעו יחד אל הציון, וכל אחד מהם נושע בעניינו.)",
        source: "מקור: ״שחרית״, עמ׳ 18" },
      { tag: "זיווג", img: "assets/hilula/tent-night.jpg",
        title: "התארס בליל ההילולה",
        sum: "רווק מבוגר — והתארס בליל ההילולה",
        full: "רווק מבוגר שנסע עם החבורה אל הציון ביקש על זיווגו. לפי הסיפור — התארס בליל ההילולה עצמו. (ארבעה נסעו יחד אל הציון, וכל אחד מהם נושע בעניינו.)",
        source: "מקור: ״שחרית״, עמ׳ 18" },
      { tag: "רפואה", img: "assets/segulot/refua.jpg",
